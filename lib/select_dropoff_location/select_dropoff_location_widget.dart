...
class SelectDropoffLocationWidget extends StatefulWidget {
  const SelectDropoffLocationWidget({
    Key? key,
  ...
  @override
  _SelectDropoffLocationWidgetState createState() =>
      _SelectDropoffLocationWidgetState();
}

class _SelectDropoffLocationWidgetState
    extends State<SelectDropoffLocationWidget> {
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Builder(builder: (context) {
                      final _googleMapMarker = widget.dropoffLocation;
