...
import 'schema/emergency_person_record.dart';
...
export 'schema/emergency_person_record.dart';
...
/// Functions to query EmergencyPersonRecords (as a Stream and as a Future).
Future<int> queryEmergencyPersonRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EmergencyPersonRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EmergencyPersonRecord>> queryEmergencyPersonRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<EmergencyPersonRecord>> queryEmergencyPersonRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<EmergencyPersonRecord>> queryEmergencyPersonRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
