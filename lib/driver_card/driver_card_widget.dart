...
import '../scan_q_r/scan_q_r_widget.dart';
...
class DriverCardWidget extends StatefulWidget {
  const DriverCardWidget({Key? key}) : super(key: key);
...
class _DriverCardWidgetState extends State<DriverCardWidget>
  ...
  TextEditingController? driverGenderController;
  ...
  void initState() {
    ...
    driverGenderController = TextEditingController();
    driverNameController =
        TextEditingController(text: random_data.randomName(true, true));
    driverPhoneController = TextEditingController(
        text: valueOrDefault<String>(
      random_data.randomInteger(10, 11).toString(),
      '0123456789',
    ));
    titleRoleController =
  ...
  void dispose() {
    ...
    driverGenderController?.dispose();
              ...
              children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(85, 16, 16, 0),
                              child: TextFormField(
                                controller: driverGenderController,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Gender',
                                  hintStyle:
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(50, 16, 16, 0),
                              child: TextFormField(
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      final driverCreateData = createDriverRecordData(
                        driverName: driverNameController!.text,
                        driverPhoneNumber: driverPhoneController!.text,
                        driverGender: valueOrDefault<String>(
                          driverGenderController!.text,
                          'Male',
                        ),
                        driverPhotoUrl: currentUserPhoto,
                      );
                      await DriverRecord.collection.doc().set(driverCreateData);
